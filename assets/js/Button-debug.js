...
Ext.define('Rg.be.mp.pmanager.ButtonInstall', {
    ...
    listeners: {
        ...
        click: function (me, e, eOpts) {
            ...
            Ge.app.widget.load('@backend/marketplace/pmanager/install/view', {installId: row.installId});
        }
    }
});
    ...
    listeners: {
         ...
         */
         click: function (me, e, eOpts) {
            let row = me.selectorCmp.getStore().getOneSelected();
            // row.install = 'path,namespace'
            Ge.app.widget.load('@backend/marketplace/pmanager/widget/delete', {installId: row.installId});
        }
    }
});
...
/**
 * @class Rg.be.mp.pmanager.ButtonDownload
 * @extends Ge.view.grid.button.Button
 * Кнопка "Скачать" на панели инструментов сетки.
 * Скачивание файла пакета плагина.
 */
 Ext.define('Rg.be.mp.pmanager.ButtonDownload', {
    extend: 'Ge.view.grid.button.Button',
