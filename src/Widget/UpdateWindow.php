...
class UpdateWindow extends Window
{
    ...
    protected function init(): void
    {
        ...
        $this->ui        = 'light';
        $this->cls       = 'rg-mp-pmanager-update';
    ...
    public function renderSteps(): array
    {
        ...
        foreach ($this->steps as $step) {
            ...
            $html .= '<div class="rg-mp-pmanager-update__step' . $active .'"><i class="fal fa-check"></i> ' . $title . '</div>';
        }
        return [
            'xtype' => 'container',
            'cls'   => 'rg-mp-pmanager-update__steps',
            'html'  => $html
        ];
    }
    ...
    public function renderFormItems(): array
    {
        return [
            ...
            [
                'xtype' => 'container',
                'cls'   => 'rg-mp-pmanager-update__notice',
                'html'  => '#{update.notice}'
            ],
            [
                'xtype' => 'hidden',
