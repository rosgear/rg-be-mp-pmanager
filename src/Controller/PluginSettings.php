...
class PluginSettings extends FormController
{
    ...
    public function viewAction(): Response
    {
        ...
        $pluginParams = Ge::$app->plugins->getRegistry()->getAt($id);
        ...
        Ge::$loader->addPsr4($pluginParams['namespace']  . NS, Ge::$app->modulePath . $pluginParams['path'] . DS . 'src');
        ...
        $category->patterns['plugin'] = [
            'basePath' => Ge::$app->modulePath . $pluginParams['path'] . DS . 'lang',
            'pattern'  => 'text-%s.php',
        ];
    ...
    public function dataAction(): Response
    {
        ...
        $model = Ge::$app->plugins->getModel(
            'Settings', $pluginParams['id'], ['basePath' => Ge::$app->modulePath . $pluginParams['path'], 'module' => $this->module]
        );
